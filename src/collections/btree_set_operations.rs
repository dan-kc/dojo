...
//
// Run with: cargo test btree_set_operations
...
fn ordered_set_operations<T>(
    #[allow(unused_variables)] set_a: &std::collections::BTreeSet<T>,
    #[allow(unused_variables)] set_b: &std::collections::BTreeSet<T>,
) -> (
