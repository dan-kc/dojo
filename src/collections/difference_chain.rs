// HashSet Difference Chain Practice
//
// Learning objectives:
// - Apply set difference operations consecutively
// - Work with sequences of set operations
// - Understand set subtraction patterns
//
