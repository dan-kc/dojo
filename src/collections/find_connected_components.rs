// Graph Connected Components with HashSet Practice
//
// Learning objectives:
// - Use HashSet for graph algorithms and visited tracking
// - Implement depth-first search with sets
// - Work with graph edge representations
//
// Run with: cargo test find_connected_components
...
mod tests {
    ...
    fn test_connected_components_complex_graph() {
        ...
        let edges = vec![
            ...
            (4, 5), (5, 6), (6, 7), (7, 4), (4, 6), // Complex component: {4, 5, 6, 7}
            (8, 9), // Simple pair: {8, 9}
        ];
