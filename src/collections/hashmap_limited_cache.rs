// Limited Cache Practice
//
// Learning objectives:
// - Implementing cache with size constraints
// - Using FIFO eviction policies
// - Combining HashMap with Vec for ordering
//
// Run with: cargo test hashmap_limited_cache
