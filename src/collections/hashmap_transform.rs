...
mod tests {
    ...
    fn test_transform_hashmap() {
        ...
        let transformed =
            transform_hashmap(map, |k: &str| k.to_lowercase(), |v| v * 2, |v1, v2| v1 + v2);
    ...
    fn test_transform_empty_map() {
        ...
        let transformed = transform_hashmap(empty, |k| k + 1, |v| v.len(), |v1, v2| v1 + v2);
