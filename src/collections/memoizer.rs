...
//
// Learning objectives:
// - Implementing caching with interior mutability
// - Using RefCell for shared mutable access
// - Creating function memoization patterns
//
// Run with: cargo test memoizer
