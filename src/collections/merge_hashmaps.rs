...
//
// Learning Objectives:
// - Master HashMap merging with value combination
// - Use the Entry API to handle conflicts efficiently
// - Work with generic functions and closure parameters
// - Practice functional programming patterns with collections
//
// Run with: cargo test --bin merge_hashmaps
