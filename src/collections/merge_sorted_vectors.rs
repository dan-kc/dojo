// Merge Sorted Vectors Practice
//
// Learning Objectives:
// - Work with multiple Vec inputs efficiently
// - Use Vec::extend and sorting operations
// - Practice vector merging algorithms
// - Handle empty vector edge cases
//
// cargo test --bin merge_sorted_vectors
