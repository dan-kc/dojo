// HashSet Partitioning Practice
//
// Learning objectives:
// - Partition sets based on predicate functions
// - Use closures and function traits effectively
// - Understand set filtering and conditional separation
//
// Run with: cargo test partition_set
...
mod tests {
    ...
    fn test_partition_strings() {
        let set: HashSet<&str> = ["short", "a", "longer", "word", "x"].iter().cloned().collect();
