// Parallel Map Operation Practice
//
// Learning Objectives:
// - Implement parallel processing patterns
// - Use thread pool for efficient parallel computation
// - Apply functions to collections in parallel
// - Handle work distribution across threads
//
// cargo test --bin parallel_map
...
where
    ...
    R: Send + 'static,
{
    todo!("Implement parallel_map using thread pool")
}
...
mod tests {
    ...
    fn test_performance_improvement() {
        ...
        let sequential_result: Vec<i32> = large_input.iter().map(|&x| {
